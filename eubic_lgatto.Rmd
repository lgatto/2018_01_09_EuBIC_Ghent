...
- Leads to how does the mass spectrometry and proteomics work I am
  involved in fits in the wider project.
- Because open source and open development isn't done in glorious
  isolation, or at least that isn't when openness shines.
...
and is **open source** and **open development**. It has two releases
each year,
...
Coincidently, Mike Love, the main developer of `DESeq2` posted this on
twitter last night, and I was very happy that he was inclusive of
proteomics.
...
An essential aspect to Bioconductor and its success is the
availability of core data infrastructure that is used across
...
- And while `xcms` and `pRolocdata` are miles away in terms of
  audience, users, applications, from a software development
  perspective, they have grown a shared root infrastructure.
